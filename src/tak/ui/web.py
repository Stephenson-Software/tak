...
# The page (and the asset cache it reads through) live in tak.web.page; they
# are re-exported here because this is where consumers and tests found them.
# _clientAssetCache is the same dict object in both modules: empty it with
# .clear(), never rebind it.
from tak.web.page import (  # noqa: F401,E402 - re-exported
    DEFAULT_TIP,
    _clientAsset,
    _clientAssetCache,
    _escape,
